...
import { ORDER_CREATE_RESET } from "../redux/contants/order-constant";
...
export default function PlaceOrderScreen(props) {
  ...
  return (
    <div>
      ...
      <div className="row top placed-order-container">
        <div className="col-2 order-data-2">
          <ul>
            <li>
              <div className="card card-body place-order-shipping">
                <h2>Shipping</h2>
                <p>
            ...
            <li>
              <div className="card card-body place-order-shipping">
                <h2>Order Items</h2>
                <ul className="place-order-overflow">
